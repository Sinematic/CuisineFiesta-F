...
function Ingredient(props : { index: number }) {
    ...
    return (
        <div className="ingredient-wrapper">
            ...
            label={"Ingrédient n° " + props.index} placeholder={true} />
            <Input onChange={(e) => setAmount(e.target.value)} value={amount} 
            name="ingredientAmount" type="number" label="Quantité" placeholder={true} maxLength={4} />
